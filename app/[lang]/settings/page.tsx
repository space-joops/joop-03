...
export default async function SettingsPage({
  ...
  return (
    <main
      className="mx-auto flex w-full max-w-md flex-1 flex-col px-4 pb-2 pt-[calc(env(safe-area-inset-top)+1rem)]"
      style={{ background: "var(--color-bg)" }}
    >
      <SettingsView lang={lang} dict={dict} mine={mine} />
      <BottomNav lang={lang} dict={dict} items={["home", "myJoop", "inventory", "map", "settings"]} active="settings" />
    </main>
  );
}
