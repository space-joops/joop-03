...
export type ConfigGroup = "orbital" | "minigame" | "arcade" | "space" | "launch";
...
export const CONFIG_SPECS: readonly ConfigSpec[] = [
  ...
  },
  {
    key: "arcade_thrust",
    label: "분사 가속",
    description: "조이스틱 풀분사 시 초당 가속량(화면 최소변 기준). 클수록 기민하지만 제어가 어려워집니다.",
    group: "arcade",
    type: "float",
    min: 0.1,
    max: 6,
  ...
  {
    key: "arcade_max_speed",
    label: "최대 속도",
    description: "속도 상한(화면 최소변/초). 이 값을 넘으면 방향은 유지한 채 크기만 잘립니다.",
    group: "arcade",
    type: "float",
    min: 0.1,
    max: 4,
  ...
  },
  {
    key: "arcade_fuel",
    label: "초기 분사가스",
    description: "한 판에 주어지는 연료. 다 쓰면 게임이 끝납니다(FR-7.6). 연료 아이템으로 충전됩니다.",
    group: "arcade",
    type: "float",
    min: 10,
    max: 1000,
  ...
  {
    key: "arcade_fuel_burn",
    label: "연료 소모율",
    description: "풀분사(세기 1.0) 시 초당 소모량. 조이스틱 안쪽 링으로 미세 조정하면 그만큼 덜 씁니다.",
    group: "arcade",
    type: "float",
    min: 0.5,
    max: 100,
  ...
  },
  {
    key: "arcade_friction",
    label: "마찰",
    description: "0이면 관성이 유지됩니다(FR-7.5 기본). 0보다 크면 분사를 멈췄을 때 서서히 감속합니다.",
    group: "arcade",
    type: "float",
    min: 0,
    max: 2,
  ...
  {
    key: "arcade_spawn_interval",
    label: "쓰레기 생성 간격",
    description: "새 물체가 화면 밖에서 진입하는 간격입니다.",
    group: "arcade",
    type: "float",
    min: 0.2,
    max: 5,
  ...
  {
    key: "arcade_fuel_item_ratio",
    label: "연료 아이템 비율",
    description: "생성 물체 중 연료 보급 아이템의 비율. 높을수록 한 판이 길어집니다.",
    group: "arcade",
    type: "float",
    min: 0,
    max: 0.6,
  ...
  {
    key: "arcade_max_debris_per_run",
    label: "한 판 최대 인정 수거(조각)",
    description:
      "클라이언트가 보고한 수거 조각 수의 상한. 넘는 값은 버리지 않고 이 값으로 잘라(클램핑) 반영합니다.",
    group: "arcade",
    type: "int",
    min: 1,
    max: 100_000,
  ...
  },
  {
    ...
    label: "수신 지역 게이트",
    description:
      "1이면 교신 가능(음영 아님) 상태에서만 아케이드에 진입할 수 있습니다(FR-6.6). 0이면 항상 진입 가능(테스트용).",
    group: "arcade",
    type: "int",
    min: 0,
    max: 1,
